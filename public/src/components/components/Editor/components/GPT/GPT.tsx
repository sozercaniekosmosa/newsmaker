    ...
    return <div className="d-flex flex-column w-100 flex-stretch" style={{position: 'relative'}}>
        <ButtonGroup>
            <Button variant="secondary btn-sm"
                    onClick={() => setPrompt('Выдели основные мысли и сократи текст до 30 слов')}>Обобщение</Button>
            <Button variant="secondary btn-sm" onClick={() => setPrompt('Перефразируй')}>Перефразируй</Button>
            <Button variant="secondary btn-sm" onClick={() => onGPT('mistral', 'число в текст')}>Переведи число в
                текст</Button>
            ...
            <Button variant="secondary btn-sm"
                    onClick={() => setPrompt('Выдели основные мысли и на основе них сделай несколько не больше 4 тегов. формат ответа: тег, тег, тег')}>Теги</Button>
        </ButtonGroup>
